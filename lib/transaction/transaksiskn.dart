...
class TransaksiSKN extends StatefulWidget {
  const TransaksiSKN({super.key});

  @override
  State<TransaksiSKN> createState() => _TransaksiSKNState();
}

class _TransaksiSKNState extends State<TransaksiSKN> {
  @override
